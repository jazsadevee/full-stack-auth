...
- Authorization is (now that we know who the user is - Authentication) what can this user do? This is where we define what resources the user has access to and what actions (CRUD) the user can perform on those resources
